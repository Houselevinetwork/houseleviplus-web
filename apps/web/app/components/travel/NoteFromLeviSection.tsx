...
// Default copy Ã¢â‚¬â€ admin can override via web+ panel
const DEFAULT_NOTE = `Travel, Curated.

My work is shaped by wilderness, light, and the art of arrival.

From the private conservancies of Kenya and the volcanic highlands of Rwanda to the deserts of Namibia, the waterways of Botswana, and the quiet islands of the Indian Ocean Ã¢â‚¬â€ Seychelles, Mauritius, Zanzibar, Madagascar Ã¢â‚¬â€ each journey begins long before departure.

I do not lead tours.
I curate movement across Africa and beyond Ã¢â‚¬â€ with precision, discretion, and a deep understanding of place.
    ...
    <section className="note-from-levi">
      <div className="note-from-levi__inner">
        ...
        {note?.signatureImageUrl ? (
          ...
          <p className="note-from-levi__signature-text">Ã¢â‚¬â€ Levi</p>
        )}
      </div>
    </section>
  );
