...
const SOCIALS = [
  { label: 'Facebook',  href: 'https://web.facebook.com/profile.php?id=61581288838638',
  ...
  { label: 'Instagram', href: 'https://www.instagram.com/thereelafrika/',
  ...
  { label: 'TikTok', href: 'https://www.tiktok.com/@the_reelafrika',
  ...
  { label: 'X', href: 'https://x.com/thereelafrika',
      ...
      <div className="footer-wrap">
        ...
        <div className="footer-bottom">
          <p className="footer-copy">
            ÃƒÂ¯Ã‚Â¿Ã‚Â½ 2026 House Levi Network. All rights reserved.
            <span className="footer-sep" aria-hidden>ÃƒÂ¯Ã‚Â¿Ã‚Â½</span>
