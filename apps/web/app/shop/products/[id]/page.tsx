 ...
 *
 * Updated product page with:
 * - NO currency conversion (prices already in KES from backend)
...
interface Variant {
  _id?: string; title: string; price: number; stock: number; sku?: string;
}
...
interface Product {
  ...
  slug: string; isFeatured: boolean; tags: string[];
  variants: Variant[];
}

// Ã¢â€â‚¬Ã¢â€â‚¬ Cart helpers Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
function addToCart(product: Product, variant: Variant | null, qty: number) {
  try {
    ...
    // Price is already in KES from backend
    ...
    if (exist) {
      ...
      cart.push({
        ...
        imageUrl: product.imageUrl, price: displayPrice,
        variant: variant?.title ?? null, qty,
      });
    }
...
// Ã¢â€â‚¬Ã¢â€â‚¬ Icons Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
...
const CAT_LABELS: Record<string, string> = {
  'old-money-closet':   "Levi's Old Money Closet",
  'aviation-gear':      'Aviation Gear',
  'scale-collectibles': 'Scale Collectibles',
  'host-merch':         'Host Merch',
  'book-club':          'Book Club',
  'hl-merch':           'HL Merch',
  'partner-brands':     'Partner Brands',
  'car-collectibles':   'Car Collectibles',
};
    ...
    <>
      ...
      <div className="hl-product" style={{ background: '#fff', minHeight: '100vh', fontFamily: 'Lato, sans-serif' }}>
          ...
          <div style={{ maxWidth: 1200, margin: '0 auto', display: 'flex', alignItems: 'center', gap: 8, height: 46, fontFamily: 'Lato', fontSize: 11, color: 'rgba(18,18,18,0.5)', letterSpacing: '0.08em' }}>
            ...
            {product?.category && (
              <>
                ...
                <Link href={`/shop/collections/${product.category}`} style={{ color: 'rgba(18,18,18,0.5)', textDecoration: 'none' }}>
            ...
            {product && (
              <>
                <span style={{ opacity: 0.4 }}>/</span>
                <span style={{ color: '#121212' }}>{product.name}</span>
              </>
            )}
          </div>
        </div>
        ...
        <div className="product-grid" style={{ maxWidth: 1200, margin: '0 auto', padding: '48px 60px 80px', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 64, alignItems: 'start' }}>
          ...
          {/* Ã¢â€â‚¬Ã¢â€â‚¬ Left: Images Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬ */}
          <div>
            {loading ? (
          ...
          {/* Ã¢â€â‚¬Ã¢â€â‚¬ Right: Info Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬ */}
          <div style={{ paddingTop: 8 }}>
            {loading ? (
              ...
              <div style={{ fontFamily: 'Lato', fontSize: 14, color: '#a0291e', padding: 20 }}>
                ...
                <Link href="/shop" style={{ color: '#1b3d7b', textDecoration: 'underline' }}>Ã¢â€ Â Back to Shop</Link>
              </div>
            ) : product ? (
              <>
                {product.category && (
                  <Link href={`/shop/collections/${product.category}`} style={{ fontFamily: "'Julius Sans One', sans-serif", fontSize: 10, color: 'rgba(18,18,18,0.45)', letterSpacing: '0.25em', textTransform: 'uppercase', textDecoration: 'none', marginBottom: 14, display: 'inline-block', transition: 'color 0.15s' }}>
                    {CAT_LABELS[product.category] ?? product.category}
                  </Link>
                )}

                <h1 style={{ fontFamily: '"Frank Ruhl Libre", serif', fontSize: 'clamp(22px,2.8vw,32px)', fontWeight: 500, color: '#121212', letterSpacing: '0.4px', lineHeight: 1.25, marginBottom: 18 }}>
                  {product.name}
                </h1>
                ...
                <div style={{ display: 'flex', alignItems: 'baseline', gap: 14, marginBottom: 24 }}>
                  {product.onSale && product.salePrice !== null ? (
                    <>
                      <span style={{ fontFamily: 'Lato', fontSize: 13, color: 'rgba(18,18,18,0.45)', letterSpacing: 1, textDecoration: 'line-through' }}>KSh {product.price.toLocaleString()}</span>
                      <span style={{ fontFamily: 'Lato', fontSize: 22, fontWeight: 700, color: '#DC2626', letterSpacing: 0.5 }}>KSh {displayPrice.toLocaleString()}</span>
                    </>
                  ) : (
                ...
                {product.variants?.length > 1 && (
                  <div style={{ marginBottom: 24 }}>
                    <label style={{ fontFamily: 'Lato', fontSize: 11, fontWeight: 700, letterSpacing: '0.15em', textTransform: 'uppercase', color: 'rgba(18,18,18,0.6)', display: 'block', marginBottom: 10 }}>
                      {selectedVariant ? `${selectedVariant.title} Ã¢â‚¬â€ KSh ${selectedVariant.price.toLocaleString()}` : 'Select Option'}
                    </label>
                    <div style={{ display: 'flex', gap: 8, flexWrap: 'wrap' }}>
                      {product.variants.map((v, i) => (
                        <button key={i} className="variant-btn" onClick={() => setSelectedVariant(v)} style={{ padding: '9px 18px', fontFamily: 'Lato', fontSize: 12, letterSpacing: '0.06em', background: selectedVariant?.title === v.title ? '#121212' : '#fff', color: selectedVariant?.title === v.title ? '#fff' : '#121212', border: `1px solid ${selectedVariant?.title === v.title ? '#121212' : '#d8d4cc'}`, cursor: v.stock === 0 ? 'not-allowed' : 'pointer', opacity: v.stock === 0 ? 0.4 : 1, transition: 'all 0.15s' }}>
                          {v.title}
                        </button>
                      ))}
                    </div>
                ...
                <div style={{ marginBottom: 24 }}>
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', border: '1px solid #d8d4cc', width: 120 }}>
                    <button className="qty-btn" onClick={() => setQty(q => Math.max(1, q - 1))} style={{ width: 40, height: 44, background: '#fff', border: 'none', cursor: 'pointer', fontSize: 18, color: '#121212', transition: 'background 0.15s' }}>Ã¢Ë†â€™</button>
                ...
                {!added ? (
                  ...
                  <Link
                    href="/shop/cart"
                    style={{ width: '100%', height: 54, background: '#1B5E20', border: 'none', cursor: 'pointer', color: '#fff', fontFamily: "'Julius Sans One', sans-serif", fontSize: 13, letterSpacing: '0.15em', textTransform: 'uppercase', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 10, transition: 'background 0.2s', marginBottom: 14, textDecoration: 'none' }}
                  >
                ...
                {inStock && (
                  <div style={{ fontFamily: 'Lato', fontSize: 11, color: 'rgba(18,18,18,0.45)', letterSpacing: '0.06em', marginBottom: 24, textAlign: 'center' }}>
                    {(selectedVariant?.stock ?? product.stock) < 10 ? `Only ${selectedVariant?.stock ?? product.stock} left` : 'In stock'}
                  </div>
                )}
                ...
                {product.description && (
                  <div style={{ marginBottom: 24 }}>
                    <h3 style={{ fontFamily: 'Lato', fontSize: 11, fontWeight: 700, letterSpacing: '0.15em', textTransform: 'uppercase', color: 'rgba(18,18,18,0.6)', marginBottom: 12 }}>Description</h3>
                    <p style={{ fontFamily: '"Frank Ruhl Libre", serif', fontSize: 15, color: 'rgba(18,18,18,0.75)', lineHeight: 1.8, letterSpacing: '0.3px' }}>
                      {product.description}
                    </p>
                  </div>
                )}
                ...
                {product.tags?.length > 0 && (
                  <div style={{ display: 'flex', gap: 6, flexWrap: 'wrap' }}>
                    {product.tags.map((t: string) => (
                      <span key={t} style={{ fontFamily: 'Lato', fontSize: 10, letterSpacing: '0.1em', textTransform: 'uppercase', padding: '4px 10px', background: '#f4f2ef', color: 'rgba(18,18,18,0.5)', borderRadius: 1 }}>{t}</span>
                    ))}
                  </div>
                )}
              </>
