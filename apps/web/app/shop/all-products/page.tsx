 ...
 * All data from API Ã¢â‚¬â€ no hardcoded products or categories.
 * 
 * Fetches from:
 * - GET /api/commerce/products Ã¢â€ â€™ all products
 * - GET /api/commerce/collections Ã¢â€ â€™ categories for filtering
 */
...
// Ã¢â€â‚¬Ã¢â€â‚¬ API Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
      ...
      <div className="hlap-root" style={{ width: '100%', background: '#fff', fontFamily: 'Lato, sans-serif', minHeight: '100vh' }}>
        ...
        {error && (
          <div style={{ background: '#fee2e2', color: '#991b1b', padding: '16px 20px', textAlign: 'center', fontFamily: 'Lato', fontSize: 13, letterSpacing: '0.6px' }}>
            {error} Ã¢â‚¬â€ <button onClick={() => window.location.reload()} style={{ background: 'none', border: 'none', color: '#991b1b', textDecoration: 'underline', cursor: 'pointer', fontSize: 13 }}>Retry</button>
          </div>
        )}
