 ...
 * - Editorial banner (OLD MONEY ÃƒÂ¯Ã‚Â¿Ã‚Â½ HOUSELEVI+ OFFICIAL)
...
function ProductStrip({ products, loading, empty = 'No products yet ÃƒÂ¯Ã‚Â¿Ã‚Â½ check back soon.' }: { products: Product[]; loading: boolean; empty?: string }) {
...
<div style={{ position: 'relative', width: '100%', height: '100vh', minHeight: 600, background: '#0a0a0a', overflow: 'hidden', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        ...
        {/* -- Editorial Banner ÃƒÂ¯Ã‚Â¿Ã‚Â½ OLD MONEY ÃƒÂ¯Ã‚Â¿Ã‚Â½ HOUSELEVI+ OFFICIAL -- */}
        ...
        {/* -- Levi's Closet+ ÃƒÂ¯Ã‚Â¿Ã‚Â½ Old Money category ---------------- */}
        <div style={{ background: '#fff', width: '100%', paddingBottom: 8 }}>
        ...
        {/* -- Partner Brands ÃƒÂ¯Ã‚Â¿Ã‚Â½ only shows if products exist ------- */}
          ...
          <div style={{ maxWidth: 1000, margin: '0 auto', padding: '0 60px' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 32 }}>
              ...
              <span style={{ fontFamily: 'Lato', fontSize: 13, color: 'rgba(18,18,18,0.55)', letterSpacing: '0.06em' }}>
                {data?.reviewAvg?.toFixed(1) ?? '4.5'} ÃƒÂ¯Ã‚Â¿Ã‚Â½ {data?.reviewCount ?? 0} reviews
              </span>
            </div>
