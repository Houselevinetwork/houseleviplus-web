...
const COMPARE_ROWS: { label: string; values: string[] }[] = [
  ...
  { label: 'Spatial audio',    values: ['ÃƒÂ¯Ã‚Â¿Ã‚Â½',       'ÃƒÂ¯Ã‚Â¿Ã‚Â½',         'ÃƒÂ¯Ã‚Â¿Ã‚Â½',               '?'] },
  { label: 'Early releases',   values: ['ÃƒÂ¯Ã‚Â¿Ã‚Â½',       'ÃƒÂ¯Ã‚Â¿Ã‚Â½',         '?',               '?'] },
  { label: 'VIP events',       values: ['ÃƒÂ¯Ã‚Â¿Ã‚Â½',       'ÃƒÂ¯Ã‚Â¿Ã‚Â½',         'ÃƒÂ¯Ã‚Â¿Ã‚Â½',               '?'] },
  { label: 'Priority support', values: ['ÃƒÂ¯Ã‚Â¿Ã‚Â½',       'ÃƒÂ¯Ã‚Â¿Ã‚Â½',         'ÃƒÂ¯Ã‚Â¿Ã‚Â½',               '?'] },
];
...
const FAQS = [
  ...
  },
  {
    ...
    a: 'A House Levi+ account is for people who live together in a single household. The number of simultaneous screens depends on your plan ÃƒÂ¯Ã‚Â¿Ã‚Â½ Standard allows 2, Premium VIP allows 4.',
  },
  {
  ...
  },
  {
    ...
    a: 'We offer a 7-day free trial on the Standard plan for new members. No credit card required to start ÃƒÂ¯Ã‚Â¿Ã‚Â½ you only pay if you decide to continue.',
  },
  {
    ...
    <main style={{
      ...
      <div style={{
        ...
        <p style={{ fontSize: 11, color: 'rgba(255,255,255,0.25)', marginTop: 16 }}>
          7-day free trial on Standard ÃƒÂ¯Ã‚Â¿Ã‚Â½ No commitment ÃƒÂ¯Ã‚Â¿Ã‚Â½ Cancel anytime
        </p>
      </div>
      ...
      <div style={{ padding: 'clamp(48px, 8vw, 80px) clamp(20px, 5vw, 60px)' }}>
            ...
            return (
              ...
              >
                ...
                <p style={{
                  ...
                  {plan.quality} ÃƒÂ¯Ã‚Â¿Ã‚Â½ {plan.devices} screen{plan.devices > 1 ? 's' : ''}
                </p>
        ...
        <p style={{
          ...
          <br />
          M-Pesa and card payments accepted. Cancel anytime ÃƒÂ¯Ã‚Â¿Ã‚Â½ no hidden fees.
        </p>
      </div>
      ...
      <div style={{
        ...
        <div style={{
          ...
          {[
            ...
            { icon: '??', title: 'All devices',        desc: 'Smart TV, laptop, phone or tablet ÃƒÂ¯Ã‚Â¿Ã‚Â½ your choice.' },
      ...
      <div style={{
        ...
        <p style={{
          ...
          7-day free trial on Standard plan ÃƒÂ¯Ã‚Â¿Ã‚Â½ Cancel anytime ÃƒÂ¯Ã‚Â¿Ã‚Â½ No hidden fees
        </p>
      </div>
