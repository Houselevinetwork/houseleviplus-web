...
export default function GalleryPage() {
    ...
    if (isAuthenticated && typeof window !== 'undefined') {
      ...
      if (action === 'download') {
        ...
        setTimeout(() => {
          ...
          msg.textContent = 'You are signed in � click any photo to download.';
  ...
  const handleImageClick = (imageUrl: string) => {
    if (isAuthenticated) {
      // Already logged in � download directly, no modal
  ...
  return (
    <main style={{
      ...
      {/* Sign-in modal � only shown when not authenticated */}
