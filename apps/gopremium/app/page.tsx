...
export default function ChoosePlansPage() {
  ...
  const handleSelect = (plan: Plan) => {
    if (typeof window !== "undefined") {
      ...
      window.location.href = `${WEB_URL}/payment?plan=${planParam}`;
    }
  ...
  return (
    <div className="gp-root">
      {/* Logo top-left, identical to authorize-ui */}
      ...
      <div className="cp-container">
        <main className="cp-page">
          ...
          {/* Header: title left, banner right */}
            ...
            <div className="cp-banner">
              <div className="cp-banner-left">
                ...
                <div className="cp-banner-copy">
                  ...
                  <span className="cp-banner-sub">Explore free content &mdash; no card needed.</span>
                </div>
              </div>
